...
| fr.jooble.org | Agrégateur FR, liens individuels réels (internes ou redirection vers le site source) — ajouté le 09/09/2026 |
| fr.jobrapido.com | Agrégateur FR, liens individuels via `open.app.jobrapido.com/fr/<id>` — ajouté le 09/09/2026 |
| jobijoba.com | Agrégateur FR gros volume, liens individuels `/fr/annonce/54/<hash>` — ajouté le 09/09/2026 |
| mindtheproduct.com/jobs | Board Product Manager dédié (plateforme Getro), liens `/jobs/listing/<slug>-<hash>/` — ajouté le 09/09/2026, à utiliser pour la recherche PM |
...
>
> **France Travail (ex-Pôle emploi) a une API officielle gratuite sur francetravail.io, mais nécessite un compte développeur créé par Gaëtan** (inscription + abonnement par API, même situation qu'api.adzuna.com) : voir `https://francetravail.io/data/api/offres-emploi`. Tant que le compte n'existe pas, cette source reste hors dispositif.
