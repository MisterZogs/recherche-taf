...
| `Resume_GaetanFRANCOIS_SEO.html/.pdf` | **CV visuel FR dédié aux offres SEO/GEO** (créé le 12/09/2026, dérivé du template UX Lead), demandé directement par Gaëtan sur la base des volets réels de son rôle chez WallOfTraders.com (SEO, GEO, cocons sémantiques, articles de blog, maillage interne, netlinking). Sous-titre « Responsable SEO & Product Manager », profil et premier bullet WallOfTraders.com réécrits pour faire remonter le pilotage SEO/acquisition en tête, sidebar Compétences réordonnée (SEO & stratégie éditoriale, cocons sémantiques & maillage interne, netlinking & popularité, GEO/AEO en tête). Reste du CV inchangé (L'Oréal, ALTI-TCS, formation). Pas encore de version EN à ce jour, à créer si une offre SEO/GEO rédigée en anglais le justifie |
...
> **Historique complet des relances antérieures au 2026-09-11 : voir `HISTORIQUE_RELANCES.md`** (déplacé le 2026-09-08, complété au fil des relances suivantes, la plus récente déplacée étant celle du 10/09). Ce fichier garde les verdicts détaillés source par source, les pièges découverts et les slugs ATS testés depuis le 07/08/2026. **Seules les deux relances les plus récentes doivent rester ci-dessous ; à chaque nouvel ajout, déplacer la plus ancienne des deux vers `HISTORIQUE_RELANCES.md`.**
