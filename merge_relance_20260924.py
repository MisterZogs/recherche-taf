...
FILES = [
    "relance_20260924_cluster_fr.json",
    "relance_20260924_cluster_fr_agentB.json",
    "relance_20260924_cluster_fr_OTHERPROCESS_backup.json",
    "relance_20260924_cluster_ats.json",
    "relance_20260924_cluster_remote.json",
    "relance_20260924_cluster_pb.json",
]
...
with open("relance_20260924_merged.json", "w", encoding="utf-8") as fh:
    json.dump(merged, fh, ensure_ascii=False, indent=1)

print("\nÉcrit dans relance_20260924_merged.json")
